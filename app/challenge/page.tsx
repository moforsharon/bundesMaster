...
// import { Trophy, CheckCircle, Award, FileQuestion } from "lucide-react"
...
//             <span className="text-xs font-medium">Pre-test</span>
//           </div>
...
//           {activeStep === "pretest" && (
//             // <div className="text-center py-8">{/* Nothing happens for pre-test as requested */}</div>
//             <PreTestChallenge setActiveStep={setActiveStep} />
//           )}

//           {activeStep === "challenge" && storedUserId && (
//             <div className="text-center py-8">
//               <h3 className="text-xl font-semibold mb-4">Hi this is the challenge tab</h3>
//             </div>
//           )}
...
//         {/* {activeStep !== "main" && (
//           <CardFooter>
//             <Button onClick={() => setActiveStep("main")} className="w-full bg-blue-600 hover:bg-blue-700">
//               Back to Main
//             </Button>
//           </CardFooter>
//         )} */}
...
export default function ChallengePage() {
  ...
  const [error, setError] = useState<string | null>(null)
    const [userId, setUserId] = useLocalStorage<string | null>("userId", null)
    const [userName, setUserName] = useState<string | null>(null);
    const storedUserId = localStorage.getItem("participantId")
    const challengeLevel= localStorage.getItem("challengeLevel")
